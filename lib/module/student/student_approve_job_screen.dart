...
import 'package:placemnet_system_frontend/module/student/student_approve_job_scrren_details.dart';
import 'package:placemnet_system_frontend/services/job_services.dart';
import '../Models/job_cart_item.dart';

// ignore: must_be_immutable
class StudentApprovedJobs extends StatelessWidget {
  StudentApprovedJobs({super.key});
                      ...
                      child: ListTile(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StudentApprovedJobDetails(
